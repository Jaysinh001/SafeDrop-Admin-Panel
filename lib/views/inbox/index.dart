          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                const ListTile(title: Text('Started')),
                const SizedBox(height: 10),
                const ListTile(title: Text('Snoozed')),
                const SizedBox(height: 10),
                const ListTile(title: Text('Sent')),
                const SizedBox(height: 10),
                const ListTile(title: Text('Drafts')),
                const SizedBox(height: 10),
                const ListTile(title: Text('Spam')),
                SizedBox(height: 10),
                const ListTile(title: Text('Trash')),
              ],
            ),
          ),
