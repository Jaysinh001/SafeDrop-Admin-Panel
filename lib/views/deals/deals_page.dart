...
import 'package:safedropadminpanel/views/deals/add_deals_widget.dart';
import 'package:safedropadminpanel/views/deals/deals_state.dart';
import 'package:safedropadminpanel/views/deals/deals_viewmodel.dart';
...
class DealsPage extends CrmLayout {
  ...
  Widget breakTabRightWidget(BuildContext context) {
    ...
    return Row(
      ...
      children: [SizedBox(width: 150, child: AddDealsWidget())],
    );
  }
