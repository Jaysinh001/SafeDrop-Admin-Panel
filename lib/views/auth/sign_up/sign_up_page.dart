...
import '../../../config/theme/crm_colors.dart';
import 'package:safedropadminpanel/views/auth/sign_up/sign_up_state.dart';
import 'package:safedropadminpanel/views/auth/sign_up/sign_up_viewmodel.dart';
      ...
      children: [
        Row(
          ...
          children: [
            ...
            CommonCard(width: 430, child: _formWidget(context, viewModel)),
          ],
        ),
      ],
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Expanded(
                child: Divider(height: 1, color: CrmColors.border),
              ),
              Container(
