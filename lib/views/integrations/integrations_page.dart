...
import 'package:safedropadminpanel/views/integrations/add_integrations_widget.dart';
import 'package:safedropadminpanel/views/integrations/integrations_state.dart';
import 'package:safedropadminpanel/views/integrations/integrations_viewmodel.dart';
...
class IntegrationsPage extends CrmLayout {
  ...
  Widget breakTabRightWidget(BuildContext context) {
    ...
    return Row(
      ...
      children: [SizedBox(width: 150, child: AddIntegrationsWidget())],
    );
  }
...
class IntegrationsPageView
    extends BlocBaseStlessWidget<IntegrationsViewModel, IntegrationsState> {
  ...
  Widget bodyWidget(
    ...
    return Container(
      ...
      child: Wrap(runSpacing: 20, spacing: 32, children: list),
    );
  }
    ...
    return CommonCard(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ImageWidget(imageUrl: element['image'], width: 40, height: 40),
              Spacer(),
              SizedBox(
                width: 80,
                height: 32,
  ...
  Widget separatorBuilder(BuildContext context, int index) {
    return Divider(height: 20, color: Colors.transparent);
  }
}
