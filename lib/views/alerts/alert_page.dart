          ...
          childWidget: Column(
            children: [
              _itemAlert(
                ...
                icon: Image.asset('assets/alert/icon_warn.png', width: 32),
              ...
              _itemAlert(
                ...
                icon: Image.asset('assets/alert/icon_success.png', width: 32),
                title: AppLocalizations.of(context)!.alertsTitle,
                content: AppLocalizations.of(context)!.alertsMessage,
              ...
              _itemAlert(
                ...
                icon: Image.asset('assets/alert/icon_fail.png', width: 32),
                title: AppLocalizations.of(context)!.alertsTitle,
                content: AppLocalizations.of(context)!.alertsMessage,
  ...
  _itemAlert({
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Container(width: 4, height: double.maxFinite, color: borderColor),
