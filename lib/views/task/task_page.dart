...
import 'package:safedropadminpanel/views/task/add_task_widget.dart';
import 'package:safedropadminpanel/views/task/task_state.dart';
import 'package:safedropadminpanel/views/task/task_viewmodel.dart';
...
class TasksPage extends CrmLayout {
  ...
  Widget breakTabRightWidget(BuildContext context) {
    ...
    return Row(
      ...
      children: [SizedBox(width: 150, child: AddTaskWidget())],
    );
  }
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              const Icon(Icons.more_horiz, color: CrmColors.paragraph),
            ],
          ),
          const SizedBox(height: 20),
          Text(
