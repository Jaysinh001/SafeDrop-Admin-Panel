...
import '../layout.dart';
import 'personal_avatar_widget.dart';
...
class SettingsPage extends LayoutWidget {
  ...
  Widget _desktopWidget(BuildContext context) {
    return Row(
      ...
      children: [
        Expanded(child: _leftWidget(context), flex: 3),
        const SizedBox(width: 16),
        Expanded(child: _rightWidget(context), flex: 2),
      ],
    );
  }
  ...
  _leftWidget(BuildContext context) {
    return const Column(children: [PersonalInfoWidget(), SizedBox(height: 20)]);
  }
