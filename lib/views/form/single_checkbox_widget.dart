...
class SingleCheckboxWidget extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> checkBoxList = [
    {'name': 'Info', 'color': GlobalColors.info},
    {'name': 'Success', 'color': GlobalColors.success},
    {'name': 'Warn', 'color': GlobalColors.warn},
    {'name': 'Primary', 'color': GlobalColors.primary},
    {'name': 'Error', 'color': GlobalColors.danger},
  ];
