...
import '../../config/components/charts/map_chart.dart';
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          ...
          Expanded(flex: 4, child: CommonCard(child: const MapChartWidget())),
        ],
      ),
    );
  }
  ...
  Widget _analyticsMobile(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 350, child: CommonCard(child: const MapChartWidget())),
      ],
    );
  }
}
