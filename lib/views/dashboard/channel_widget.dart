...
import '../../config/components/chats.dart';
import '../../config/components/tables/TopChannel.dart';
...
class ChannelWidget extends StatelessWidget {
  ...
  Widget _channelsWeb(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        children: [
          // Expanded(flex: 2, child: TopChannelWidget()),
  ...
  Widget _channelMobile(BuildContext context) {
    return Column(
      children: [
        // SizedBox(height: 380, child: TopChannelWidget()),
