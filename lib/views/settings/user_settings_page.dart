...
class UserSettingsPage extends CrmLayout {
  ...
  Widget contentDesktopWidget(BuildContext context) {
    return Row(
      ...
      children: [
        Expanded(child: _infoCardWidget(context, false), flex: 2),
        const SizedBox(width: 20),
        Expanded(child: _profileCardWidget(context), flex: 1),
      ],
    );
  }
    ...
    return CommonCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _dropField('Job', ["Flutter Developer", 'Web Designer'], isMobile),
          const SizedBox(height: 20),
          Row(
            ...
            children: [
              const SizedBox(
                width: 125,
                child: ButtonWidget(btnText: 'Cancel'),
              ),
  ...
  _infoDivider(String text) {
    return Row(
      children: [
        const Expanded(child: Divider(color: CrmColors.border)),
        Text(text, style: const TextStyle(color: CrmColors.paragraph)),
        const Expanded(child: Divider(color: CrmColors.border)),
      ],
    );
  }
  ...
  _leftContainer({required String text}) {
    return SizedBox(
      width: 200,
      child: Text(text, style: const TextStyle(color: CrmColors.paragraph)),
    );
  }
}
