...
// class StudentsListView extends GetView<DriversListController> {
...
//                 Obx(
//                   () => Text(
//                     '${controller.filteredStudents.length} drivers found',
//                     style: Theme.of(
//                       context,
...
//                         ),
//                       ),
//                       DataCell(_buildDriverStatusChips(student)),
//                       DataCell(Text(_formatDate(student.createdAt))),
//                       DataCell(
//                         ElevatedButton.icon(
//                           onPressed: () => controller.openDriverDetails(student),
...
//           return _DriverCard(
//             student: student,
//             onTap: () => controller.openDriverDetails(student),
//           );
//         },
//       ),
//     );
...
//   Widget _buildDriverStatusChips(Student student) {
//     return Wrap(
//       spacing: 4,
//       runSpacing: 4,
//       children: [
//         _buildStatusChip(
//           'Bank',
//           student.hasBankDetails == true,
//           student.hasBankDetails == true ? Colors.green : Colors.orange,
//         ),
//         _buildStatusChip(
//           'MPIN',
//           student.mpinSet == true,
//           student.mpinSet == true ? Colors.blue : Colors.red,
//         ),
//       ],
//     );
//   }
...
//                         student.profilePicture == null
//                             ? Text(
//                               (student.driverName ?? 'N')[0].toUpperCase(),
//                               style: TextStyle(
//                                 fontWeight: FontWeight.bold,
//                                 color: Colors.blue,
...
//                       children: [
//                         Text(
//                           student.driverName ?? 'Unknown Student',
//                           style: TextStyle(
//                             fontWeight: FontWeight.bold,
...
//                         Text(
//                           'ID: ${student.id} • Code: ${student.uniqueCodeId ?? 'N/A'}',
//                           style: TextStyle(
//                             color: Colors.grey[600],
...
//                     student.mpinSet == true ? Colors.blue : Colors.red,
//                   ),
//                   if (student.hasBankDetails == true && student.mpinSet == true)
